...
This is a simple portfolio webpage that contains links to some of the projects I have done at school.
...
The user can use to source code to generate their own portfolio.
